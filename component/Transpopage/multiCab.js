...
const MultiCab = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        <Text style={styles.placeName}>Multi-Cab</Text>
  ...
  <View style={styles.routeContainer}>
    <View style={styles.routeRow}>
      <Text style={styles.routeText}>PCH → Public Market </Text>
      <Text style={styles.fareText}>PHP 10.00</Text>
    </View>
    <View style={styles.routeRow}>
      <Text style={styles.routeText}>Town Plaza → Barangay Hall</Text>
      <Text style={styles.fareText}>PHP 15.00</Text>
    </View>
    <View style={styles.routeRow}>
  <Text style={styles.routeText}>PCH → Alae</Text>
  <Text style={styles.fareText}>PHP 13.00</Text>
</View>
